...
const TaskComponent = ({ task, complete, remove}) => {
    ...
    /**
     * 
     * Function that return icon depending on compleetion of the task
     */
...
TaskComponent.propTypes = {
    task: PropTypes.instanceOf(Task).isRequired, // instanceOf indica que se le va a pasar una tarea, y no un tipo de dato especificado
